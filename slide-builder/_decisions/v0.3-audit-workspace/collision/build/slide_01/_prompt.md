# Slide 1 build prompt — `Light AR findings`

You are building **slide 1 of 2** of a deck using `slide-builder` (v2). Produce **three structurally distinct options** as standalone runnable Python scripts: `option_A.py`, `option_B.py`, `option_C.py`. Each script builds **this single slide** against the client template and is executed by `finalize_deck.py` at finalize time.
...
**Slide title:** Light AR findings

**Governing thought (the claim):**
Three gaps drive the cash leakage.

**So-what (the takeaway):**
Fix these three to recover $X.

**Editorial emphasis:**
Cash app, disputes, credit memos.
...
2. **Take the highest-scoring pattern.** If two or more tie, use the rotation seed.
   ...
   - Your pattern-pick seed: `52a394cbd583c34b96d824cca066fb16`
...
PATTERN PICK — Slide 1
  ...
  Seed used?    : <yes/no — yes if you tiebroke with 52a394cbd583c34b96d824cca066fb16>
...
- Use the per-option variant seeds to vary your starting variant choice — each of the three options has its own seed so the three end up on different variants. The seeds also prevent 5 parallel agents on the same brief from picking the same variant set.
  - Option A variant seed: `21ba12e729146698aeb5acdc4fbb4790`
  - Option B variant seed: `055578f2cda8235ae6cca12533c028a2`
  - Option C variant seed: `25255a0eb154a8683560c7a1645d49df`
...
Write three files to `C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-audit-workspace\collision\build\slide_01`:

```
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-audit-workspace\collision\build\slide_01\option_A.py
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-audit-workspace\collision\build\slide_01\option_B.py
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-audit-workspace\collision\build\slide_01\option_C.py
```
...
And in the same `C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-audit-workspace\collision\build\slide_01`:
...
Output directory        : C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-audit-workspace\collision\build\slide_01
```
