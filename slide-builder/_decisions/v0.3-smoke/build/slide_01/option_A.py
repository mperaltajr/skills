"""Minimal smoke option for slide 1. Builds a one-slide PPTX
...
add_title_block(slide, "OTC body light - inherited title placeholder")

add_text(
    slide, "body-1", "Slide 1: title goes into the inherited title placeholder; OTC chrome stays.",
