# Slide 2 build prompt — `OTC body dark via overlay`

You are building **slide 2 of 3** of a deck using `slide-builder` (v2). Produce **three structurally distinct options** as standalone runnable Python scripts: `option_A.py`, `option_B.py`, `option_C.py`. Each script builds **this single slide** against the client template and is executed by `finalize_deck.py` at finalize time.
...
**Slide title:** OTC body dark via overlay

**Governing thought (the claim):**
body_overlay_hex paints a dark rectangle over the layout body zone.

**So-what (the takeaway):**
light_on_dark text on dark background; OTC chrome still visible behind overlay.

**Editorial emphasis:**
(none specified)

**Evidence / content:**
Slide has a body-overlay rectangle as the first slide-level shape.
...
2. **Take the highest-scoring pattern.** If two or more tie, use the rotation seed.
   ...
   - Your pattern-pick seed: `cd86f36ba58535e707b5dda84aec8ca6`
...
PATTERN PICK — Slide 2
  ...
  Seed used?    : <yes/no — yes if you tiebroke with cd86f36ba58535e707b5dda84aec8ca6>
...
- Use the per-option variant seeds to vary your starting variant choice — each of the three options has its own seed so the three end up on different variants. The seeds also prevent 5 parallel agents on the same brief from picking the same variant set.
  - Option A variant seed: `1f30662b18336f1b7c10e54dec33e658`
  - Option B variant seed: `fddab0c90047d276a6c2b57eab41cb5d`
  - Option C variant seed: `8e8728f6cdc41bb3a319c7d1963de9e4`
...
Write three files to `C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_02`:

```
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_02\option_A.py
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_02\option_B.py
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_02\option_C.py
```
...
```python
# Slide 2 option <A|B|C> — pattern: <picked pattern name>
...
```python
# SKELETON_REJECTED: <one-line reason — e.g., brief enumerates 2 items, pattern needs 4 cells>
# Slide 2 option <A|B|C> — pattern attempted: <pattern name>
import sys
sys.exit(0)
```
...
And in the same `C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_02`:
...
Output directory        : C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_02
```
