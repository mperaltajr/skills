# Slide 3 build prompt — `OTC body light - second slide`

You are building **slide 3 of 3** of a deck using `slide-builder` (v2). Produce **three structurally distinct options** as standalone runnable Python scripts: `option_A.py`, `option_B.py`, `option_C.py`. Each script builds **this single slide** against the client template and is executed by `finalize_deck.py` at finalize time.
...
**Slide title:** OTC body light - second slide

**Governing thought (the claim):**
Second body slide to verify consistency.

**So-what (the takeaway):**
Same inherited chrome path as slide 1; no regression across slides.
...
2. **Take the highest-scoring pattern.** If two or more tie, use the rotation seed.
   ...
   - Your pattern-pick seed: `807f48d28cae281f127aba346f7228ac`
...
PATTERN PICK — Slide 3
  ...
  Seed used?    : <yes/no — yes if you tiebroke with 807f48d28cae281f127aba346f7228ac>
...
- Use the per-option variant seeds to vary your starting variant choice — each of the three options has its own seed so the three end up on different variants. The seeds also prevent 5 parallel agents on the same brief from picking the same variant set.
  - Option A variant seed: `07d068409dcb9798777522723c623a8f`
  - Option B variant seed: `4b49d961c3026384fef758dfd82d8aff`
  - Option C variant seed: `b31de67d8e60f0c69ffc41760d972b24`
...
Write three files to `C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_03`:

```
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_03\option_A.py
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_03\option_B.py
C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_03\option_C.py
```
...
```python
# Slide 3 option <A|B|C> — pattern: <picked pattern name>
...
```python
# SKELETON_REJECTED: <one-line reason — e.g., brief enumerates 2 items, pattern needs 4 cells>
# Slide 3 option <A|B|C> — pattern attempted: <pattern name>
import sys
sys.exit(0)
```
...
And in the same `C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_03`:
...
Output directory        : C:\Users\m.a.peralta\.claude\skills\.claude\worktrees\agent-abaae9e70ed8f6544\slide-builder\_decisions\v0.3-smoke\build\slide_03
```
