"""Minimal smoke option for slide 3. Builds a one-slide PPTX
...
add_title_block(slide, "OTC body light - second slide")

add_text(
    slide, "body-1", "Slide 3: second body slide for consistency check.",
